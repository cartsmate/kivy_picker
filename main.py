...
class Example(MDApp):
    ...
    def build(self):
        ...
        btn0.bind(on_press=partial(data_tables.on_toggle_entertain, 'entertain'))
        ...
        btn1.bind(on_press=partial(data_tables.on_toggle_favourite, 'favourite'))
        ...
        btn2.bind(on_press=partial(data_tables.on_toggle_garden, 'garden'))
        ...
        btn3.bind(on_press=partial(data_tables.on_toggle_music, 'music'))
        ...
        btn4.bind(on_press=partial(data_tables.on_toggle_quiz, 'quiz'))
        ...
        btn5.bind(on_press=partial(data_tables.on_toggle_roast, 'roast'))
        ...
        btn6.bind(on_press=partial(data_tables.on_toggle_sport, 'sport'))
        ...
        heading = Label(text='placeholder', color=(1, 0, 0, 1))
